...
export const findFirstProblemAttemptDetailsQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    ...
    resolve: async (query, _root, args, _context, _info) =>
      await prisma.problemAttemptDetails.findFirst({
...
export const findFirstProblemAttemptDetailsQuery = defineQuery((t) => ({
  findFirstProblemAttemptDetails: t.prismaField(findFirstProblemAttemptDetailsQueryObject(t)),
}));
